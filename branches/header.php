...
session_start();
  ...
  $oders_no = $objProduct->checkNewOrders($conn,$branch_id);
?>
    <!doctype html>
<html lang="en">
  <head>
  ...
  <body>
      ...
      <div id="top-navigation"> WELCOME<a href="#"><strong><?php echo $_SESSION['name'];?></strong></a> <span>|</span> <a href="logout.php">Log out</a> </div>
	        ...
	        <ul class="list-unstyled components mb-5">
	          ...
	          <li>
	              <a href="orders.php">New Orders  ( <?php echo $oders_no;?> )</a>
	          </li>
	          <li>
              <a href="product_delivery.php">Add Deliverer</a>
	          </li>
	          <li>
              <a href="all_deliverer.php" >All Deliverer</a>
	          </li>
	        </ul>
