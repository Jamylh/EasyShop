  ...
  <body>
      ...
      <div id="top-navigation"> WELCOME<a href="#"><strong><?php echo $_SESSION['name'];?></strong></a><span> | </span> <a href="logout.php">Log out</a></div>
	        ...
	        <ul class="list-unstyled components mb-5">
	          ...
	          <li>
	              <a href="add_grocery.php"> Add grocery</a>
	          </li>
	          <li>
              <a href="report_grocery.php">Report grocery</a>
	          </li>
	          <li>
              <a href="add_freelancer.php" > Add Free lancer</a>
	          </li>
	          <li>
              <a href="report_freelancer.php">Report Freelancer</a>
	          </li>
	        </ul>

	        <div class="footer">
	        	<p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | 2020 - SHOP EASY APPLICATION <i class="icon-heart" aria-hidden="true"></i> by <a href="../index.php" target="_blank">SHOP EASY</a>
      ...
      <div id="content" >
          <h3 class="text-center"><a href="#" >SHOP EASY CONTROL PANEL</a></h3>
              <!-- Page Content  -->
