...
<div id="container">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Display all products</li>
  </ol>
</nav> 
...
<table class="table table-hover table-dark  text-center">
  <thead>
      ...
      <td colspan="3">Current Products</td>
  ...
  <tbody>
            ...
            <?php
                 $shop_id =  $objProduct->getShopId($conn,$admin_id);
                  ...
                  $sql = "select * from products,shop_categories where products.shop_id=$shop_id and products.cat_id = shop_categories.id order by products.cat_id desc";
                    ...
                    ?>
                     <tr>
                        ...
                        <td><h3><?php echo $row['name'];?></h3></td>
                         <td><h3><?php echo $row['cat_name'];?></h3></td>
                         <?php
                         if($objProduct->checkIsOffer($conn,$row['product_id'])){
                          ?>
                        <td><h3><?php echo $row['price'];?> <span style='color:red;'>SR offer</span></h3></td>
                      ...
                      <td><h3><?php echo $row['price'];?> <span style='color:red;'>SR</span></h3></td>
                        ...
                        <td colspan="3"><a href="all_products.php?do=remove&&product_id=<?php echo $row['product_id'];?>" class="ico del" style="color:#ff2b2b">Delete</a>
                            <a href="all_products.php?do=edit&&product_id=<?php echo $row['product_id'];?>" class="ico edit" style="color:#E38A17">Edit</a>
                            <a href="all_products.php?do=offer&&product_id=<?php echo $row['product_id'];?>" ><img src="css/images/offer.png" width="10" style="color:#FFCC26">Set offer</a></td>
                    </tr>
                    <?php
